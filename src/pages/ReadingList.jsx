  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#B8C0FF] via-[#D5C6FE] to-[#EDE8FF] text-slate-800 p-6 md:p-10 relative z-0 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute top-[-5%] right-[-5%] w-[400px] h-[400px] bg-[#F59E0B] rounded-full opacity-15 blur-[80px]"></div>
        <div className="absolute bottom-[-5%] left-[-5%] w-[450px] h-[450px] bg-[#C084FC] rounded-full opacity-20 blur-[90px]"></div>
      ...
      <header className="max-w-4xl mx-auto mb-6 md:mb-8 flex flex-col md:flex-row items-center justify-between gap-3 relative">
        ...
        <div className="text-center">
          <h1 className="text-2xl md:text-4xl font-black text-indigo-950 drop-shadow-sm">
            Short Stories <span className="text-purple-600">📖</span>
          </h1>
          <p className="text-purple-900/80 text-xs md:text-sm font-semibold mt-0.5">Baca cerita menarik sambil mengasah pemahamanmu</p>
        </div>
                    ...
                    <div className="flex items-center gap-5 relative z-10 pr-4">
                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          {isRead && (
                            <span className="flex items-center px-3 py-1 bg-emerald-400/30 backdrop-blur-md text-white text-xs font-bold rounded-full border border-emerald-300/40">
                              <CheckCircle2 className="w-3.5 h-3.5 mr-1" /> Selesai
                            </span>
                          )}
                        </div>
                        <p className="text-white/85 text-sm font-medium line-clamp-2 max-w-lg italic">
                          "{story.moralValue}"
                        </p>
                      </div>
                    </div>
