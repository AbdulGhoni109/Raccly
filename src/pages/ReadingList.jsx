                    ...
                    <div className="flex items-center gap-3 relative z-10 min-w-0 pr-2">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {isRead && (
                            <span className="flex items-center px-2 py-0.5 bg-emerald-400/30 sm:backdrop-blur-md text-white text-[10px] font-bold rounded-full border border-emerald-300/40 flex-shrink-0">
